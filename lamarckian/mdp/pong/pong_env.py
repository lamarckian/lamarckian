...
class Ball(pygame.sprite.Sprite):
    ...
    def reset(self):
        ...
        init_speed_y = self.random.uniform(self._speed * 0.3, self._speed)
        self._speed_x = self.random.choice([-init_speed_x, init_speed_x])
        self._speed_y = self.random.choice([-init_speed_y, init_speed_y])
